...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function startTimer() {
      ...
      setTimeout(function () {
        if (_this2.state.inProgressBool) {
          _this2.setState({
            timeElapsed: _this2.state.timeElapsed + 1
          });
          _this2.startTimer();
        }
      }, 1000);
    ...
    key: 'problemTypeUpdate',
    value: function problemTypeUpdate(operator) {
    ...
    key: 'inProgressBoolUpdate',
    value: function inProgressBoolUpdate() {
    ...
    key: 'numberCorrectUpdate',
    value: function numberCorrectUpdate() {
      this.setState({
        numberCorrect: this.state.numberCorrect + 1
      });
    }
  }, {
    key: 'numberIncorrectUpdate',
    value: function numberIncorrectUpdate() {
      this.setState({
    ...
    value: function questionsLeftUpdate() {
      this.setState({
    ...
    value: function setNumberOfQuestions() {
      var numQuestions = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 10;
    ...
    key: 'correctArrayUpdate',
    value: function correctArrayUpdate(question) {
      this.state.correctArray.push(question);
    }
  }, {
    key: 'incorrectArrayUpdate',
    value: function incorrectArrayUpdate(question) {
      this.state.incorrectArray.push(question);
    }
  }, {
    key: 'startNewGame',
    value: function startNewGame(operator) {
...
var _QuestionAnswer = __webpack_require__(33);

var _QuestionAnswer2 = _interopRequireDefault(_QuestionAnswer);

var _Statistics = __webpack_require__(34);

var _Statistics2 = _interopRequireDefault(_Statistics);

var _problemGen = __webpack_require__(30);

var _problemGen2 = _interopRequireDefault(_problemGen);
...
var Game = function (_React$Component) {
  ...
  function Game(props) {
    ...
    _this.newQuestion = _this.newQuestion.bind(_this);
    return _this;
  }
  ...
  _createClass(Game, [{
    ...
    value: function newQuestion() {
      var infoObject = (0, _problemGen2.default)(this.props.problemType, 3, 1);
    ...
    value: function render() {
      if (this.state.questionsLeft === 0) {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_QuestionAnswer2.default, {
...
};var NavSideBar = function NavSideBar(props) {
  return _react2.default.createElement(
    'div',
    { style: style },
    _react2.default.createElement(
    ...
    _react2.default.createElement(
      'h2',
      { onClick: function onClick() {
          props.startNewGame(_underscore2.default.sample(['+', '/', 'x', '-']));
        } },
      'Random'
    )
  );
...
var InfoSideBar = function (_Component) {
  _inherits(InfoSideBar, _Component);

  function InfoSideBar(props) {
    _classCallCheck(this, InfoSideBar);

    var _this = _possibleConstructorReturn(this, (InfoSideBar.__proto__ || Object.getPrototypeOf(InfoSideBar)).call(this, props));
...
exports.Timer = exports.Answer = exports.QuestionAnswer = undefined;
...
var QuestionAnswer = function (_React$Component) {
	...
	function QuestionAnswer(props) {
		...
		_this.state = {
			...
			questionsLeft: _this.props.questionsLeft,
			timeElapsed: _this.props.timeElapsed
		};
	...
	_createClass(QuestionAnswer, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(Timer, { time: this.props.timeElapsed }),
				_react2.default.createElement(
					'span',
					null,
					'Questions Left: ',
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'ul',
          null,
          this.props.incorrectArray.map(function (incorrectQuestion, index) {
            return _react2.default.createElement(
              'li',
              { key: index },
              incorrectQuestion
        ...
        _react2.default.createElement(
          'ul',
          null,
          this.props.incorrectArray.map(function (correctQuestion, index) {
            return _react2.default.createElement(
              'li',
              { key: index },
              correctQuestion
